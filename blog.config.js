...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Xiqiuqiu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'UI、一年期前端练习生，爱好打打游戏，喜欢尝试新技术', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.xiqiuqiu.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '泛技术类博客,生活，记录', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'ixiqiuqiu@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/Luxutalk', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/xiqiuqiu', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/Xiqiuqiu', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  BACKGROUND_LIGHT: '#f8f9fa', // use hex value, don't forget '#' e.g #fffefc
  BACKGROUND_DARK: '#0d1117', // use hex value, don't forget '#'
  ...
  MUSIC_PLAYER_METING_ID: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '1997189512', // 对应歌单的 id
  ...
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'xiqiuqiu', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-WF8C2CT6B2', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
